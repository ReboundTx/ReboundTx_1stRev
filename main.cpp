...
void* KnobsThread( void* arg )
{
	...
	while( true ){
		...
		// Don't Compare values re just read to last values while the data is still sending to raspstill
...
int main( int argc, char *argv[] )
{
	...
	printf( "Start Line again...milo here\n");
	printf( "Start Line: [%s]\n", startline );
